...
export const PinContainer = ({
  ...
  // If mobile, render a simpler card without the 3D effect
  if (isMobile) {
    return (
      <Link href={href || "/"} className={cn("relative", containerClassName)}>
        <div
          className={cn(
            "p-4 sm:p-2 rounded-2xl shadow-[0_2px_4px_rgb(0_0_0/0.1)] bg-cardt border border-white/[0.1] transition duration-700",
            className
          )}
        >
          {children}
  ...
  // On larger screens, render with the 3D effect and PinPerspective overlay
  return (
    <Link
      href={href || "/"}
      target="_blank"
    ...
    >
      ...
      >
        <div
          style={{ transform }}
          className="absolute left-1/2 p-2 sm:p-2 top-1/2 flex justify-start items-start rounded-2xl shadow-[0_2px_4px_rgb(0_0_0/0.1)] bg-cardt border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden"
        >
